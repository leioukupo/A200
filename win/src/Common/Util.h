...
extern void YUV422ToRGB888(const uint8_t *pYUVImage, uint8_t *pRGBImage, uint32_t nYUVSize, uint32_t *pnActualRead,
                           uint32_t *pnRGBSize);

extern void Depth2RGB888(RGB888Pixel *pRGBImage, uint32_t *pnRGBSize, float *pHistogram, int histogramSize,
