...
DECLARE_INTERFACE(ID3D11ShaderReflectionType) {
    STDMETHOD(GetDesc)(THIS_ __out D3D11_SHADER_TYPE_DESC
    ...
    *pDesc) PURE;
    ...
    STDMETHOD(IsEqual)(THIS_ __in ID3D11ShaderReflectionType
    ...
    * pType) PURE;
    ...
    STDMETHOD(IsOfType)(THIS_ __in ID3D11ShaderReflectionType

    * pType) PURE;

    STDMETHOD(ImplementsInterface)(THIS_ __in ID3D11ShaderReflectionType
...
DECLARE_INTERFACE(ID3D11ShaderReflectionVariable) {
    STDMETHOD(GetDesc)(THIS_ __out D3D11_SHADER_VARIABLE_DESC
...
DECLARE_INTERFACE_(ID3D11ShaderReflection, IUnknown) {
    ...
    *ppv) PURE;
    ...
    STDMETHOD(GetDesc)(THIS_ __out D3D11_SHADER_DESC
    ...
    *pDesc) PURE;
    ...
    STDMETHOD(GetResourceBindingDesc)(THIS_ __in UINT ResourceIndex,
                                      __out D3D11_SHADER_INPUT_BIND_DESC

    *pDesc) PURE;

    STDMETHOD(GetInputParameterDesc)(THIS_ __in UINT ParameterIndex,
                                     __out D3D11_SIGNATURE_PARAMETER_DESC
