...
//----------------------------------------------------------------------------
typedef interface ID3DXAllocateHierarchy
ID3DXAllocateHierarchy;
typedef interface ID3DXAllocateHierarchy
*
...
// to load the data.
//----------------------------------------------------------------------------
typedef interface ID3DXLoadUserData
ID3DXLoadUserData;
typedef interface ID3DXLoadUserData
*
LPD3DXLOADUSERDATA;
...
//----------------------------------------------------------------------------
typedef interface ID3DXSaveUserData
ID3DXSaveUserData;
typedef interface ID3DXSaveUserData
*
LPD3DXSAVEUSERDATA;
...
//----------------------------------------------------------------------------
typedef interface ID3DXAnimationSet
ID3DXAnimationSet;
typedef interface ID3DXAnimationSet
*
LPD3DXANIMATIONSET;
...
PURE;       // Returns the callback data pointer
};
...
// Scale keys
STDMETHOD_(UINT, GetNumScaleKeys
)(
THIS_ UINT
Animation)
PURE;
...
// Translation keys
STDMETHOD_(UINT, GetNumTranslationKeys
)(
THIS_ UINT
Animation)
PURE;
...
*pScaleKeys,              // Array of scale keys
CONST D3DXKEY_QUATERNION
*pRotationKeys,        // Array of rotation keys
CONST D3DXKEY_VECTOR3
*pTranslationKeys,        // Array of translation keys
DWORD *pAnimationIndex
)
PURE;                    // Returns the animation index
...
//----------------------------------------------------------------------------
typedef interface ID3DXCompressedAnimationSet
ID3DXCompressedAnimationSet;
typedef interface ID3DXCompressedAnimationSet
*
...
// Scale keys
STDMETHOD (GetCompressedData)(THIS_ LPD3DXBUFFER
...
//----------------------------------------------------------------------------
typedef interface ID3DXAnimationController
ID3DXAnimationController;
typedef interface ID3DXAnimationController
*
...
THIS_ UINT
Track,
FLOAT NewSpeed, DOUBLE
StartTime,
DOUBLE Duration, D3DXTRANSITION_TYPE
Transition)
PURE;
