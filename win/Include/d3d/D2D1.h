...
interface D2D1_DECLARE_INTERFACE("2cd906a1-12e2-11dc-9fed-001143a055f9") ID2D1Geometry : public ID2D1Resource {
    ...
    *relation
    ...
    STDMETHOD(Simplify)(
            ...
            __in_opt CONST D2D1_MATRIX_3X2_F *worldTransform,
            FLOAT flatteningTolerance,
            __in ID2D1SimplifiedGeometrySink
    ...
    *contains
    ...
    {
        return StrokeContainsPoint(point, strokeWidth, strokeStyle, worldTransform, D2D1_DEFAULT_FLATTENING_TOLERANCE,
                                   contains);
    }
    ...
    *geometrySink
    ...
    {
        return CombineWithGeometry(inputGeometry, combineMode, &inputGeometryTransform, flatteningTolerance,
                                   geometrySink);
    }
    ...
    *inputGeometry,
    ...
    {
        return CombineWithGeometry(inputGeometry, combineMode, inputGeometryTransform,
    ...
    *length
    ...
    ComputePointAtLength(
        ...
        return ComputePointAtLength(length, worldTransform, D2D1_DEFAULT_FLATTENING_TOLERANCE, point,
                                    unitTangentVector);
    }
...
interface D2D1_DECLARE_INTERFACE("2cd9069f-12e2-11dc-9fed-001143a055f9") ID2D1GeometrySink
    ...
    STDMETHOD_(void, AddBezier)(
            __in CONST D2D1_BEZIER_SEGMENT

    *bezier
    ) PURE;

    STDMETHOD_(void, AddQuadraticBezier)(
            __in CONST D2D1_QUADRATIC_BEZIER_SEGMENT
...
interface D2D1_DECLARE_INTERFACE("28506e39-ebf6-46a1-bb47-fd85565ab957") ID2D1DrawingStateBlock : public ID2D1Resource {
    ...
    STDMETHOD_(void, GetDescription)(
            __out D2D1_DRAWING_STATE_DESCRIPTION
    ...
    *stateDescription
    ...
    STDMETHOD_(void, SetDescription)(
            __in CONST D2D1_DRAWING_STATE_DESCRIPTION
...
interface D2D1_DECLARE_INTERFACE("2cd90694-12e2-11dc-9fed-001143a055f9") ID2D1RenderTarget : public ID2D1Resource {
    ...
    STDMETHOD(CreateBitmap)(
            ...
            UINT32 pitch,
            __in CONST D2D1_BITMAP_PROPERTIES
    ...
    *linearGradientBrushProperties,
    ...
    __deref_out ID2D1LinearGradientBrush
    **linearGradientBrush
    ) PURE;
    ...
    *radialGradientBrushProperties,
    __in_opt CONST D2D1_BRUSH_PROPERTIES *brushProperties,
            __in
    ID2D1GradientStopCollection *gradientStopCollection,
    __deref_out ID2D1RadialGradientBrush
    **radialGradientBrush
    ) PURE;
    ...
    *brush,
    ...
    __in_opt ID2D1StrokeStyle
    *
    strokeStyle = NULL
    ) PURE;

    STDMETHOD_(void, DrawRectangle)(
            __in CONST D2D1_RECT_F
    ...
    *transform
    ...
    STDMETHOD_(void, PushLayer)(
            __in CONST D2D1_LAYER_PARAMETERS
    ...
    *dpiY
    ...
    STDMETHOD_(BOOL, IsSupported)(
            __in CONST D2D1_RENDER_TARGET_PROPERTIES
    ...
    **bitmapBrush
    ...
    CreateGradientStopCollection(
        ...
        return CreateGradientStopCollection(gradientStops, gradientStopsCount, D2D1_GAMMA_2_2, D2D1_EXTEND_MODE_CLAMP,
    ...
    CreateLinearGradientBrush(
            ...
            __in ID2D1GradientStopCollection
    ...
    *gradientStopCollection,
    ...
    {
        return CreateRadialGradientBrush(&radialGradientBrushProperties, NULL, gradientStopCollection,
                                         radialGradientBrush);
    }
    ...
    *gradientStopCollection,
    ...
    CreateCompatibleRenderTarget(
        ...
        return CreateCompatibleRenderTarget(NULL, NULL, NULL, D2D1_COMPATIBLE_RENDER_TARGET_OPTIONS_NONE,
                                            bitmapRenderTarget);
    }
    ...
    CreateCompatibleRenderTarget(
        ...
        return CreateCompatibleRenderTarget(&desiredSize, NULL, NULL, D2D1_COMPATIBLE_RENDER_TARGET_OPTIONS_NONE,
                                            bitmapRenderTarget);
    }
    ...
    CreateCompatibleRenderTarget(
        ...
        return CreateCompatibleRenderTarget(&desiredSize, &desiredPixelSize, NULL,
    ...
    CreateCompatibleRenderTarget(
        ...
        return CreateCompatibleRenderTarget(&desiredSize, &desiredPixelSize, &desiredFormat,
                                            D2D1_COMPATIBLE_RENDER_TARGET_OPTIONS_NONE, bitmapRenderTarget);
    }
...
interface D2D1_DECLARE_INTERFACE("06152247-6f50-465a-9245-118bfd3b6007") ID2D1Factory : public IUnknown {
    ...
    *transform,
    ...
    STDMETHOD(CreateStrokeStyle)(
            __in CONST D2D1_STROKE_STYLE_PROPERTIES

    *strokeStyleProperties,
    __in_ecount_opt(dashesCount)
    CONST FLOAT *dashes,
            UINT
    dashesCount,
...
D2D1CreateFactory(
        __in D2D1_FACTORY_TYPE factoryType,
        __in CONST D2D1_FACTORY_OPTIONS &
