...
public:
    virtual void STDMETHODCALLTYPE GetDesc(
            /* [annotation] */
            __out D3D11_DEPTH_STENCIL_DESC
...
public:
    virtual void STDMETHODCALLTYPE GetType(
            /* [annotation] */
            __out D3D11_RESOURCE_DIMENSION
...
struct CD3D11_SHADER_RESOURCE_VIEW_DESC : public D3D11_SHADER_RESOURCE_VIEW_DESC {
    ...
    * pTex2D,
    ...
    mipLevels = -1,
            UINT
    firstArraySlice = 0, // First2DArrayFace for TEXTURECUBEARRAY
    UINT
    arraySize = -1
    ) // NumCubes for TEXTURECUBEARRAY
    {
        ViewDimension = viewDimension;
...
public:
    virtual void STDMETHODCALLTYPE GetDesc(
            /* [annotation] */
            __out D3D11_SHADER_RESOURCE_VIEW_DESC
...
public:
    virtual void STDMETHODCALLTYPE GetDesc(
            /* [annotation] */
            __out D3D11_RENDER_TARGET_VIEW_DESC
...
public:
    virtual void STDMETHODCALLTYPE GetDesc(
            /* [annotation] */
            __out D3D11_DEPTH_STENCIL_VIEW_DESC
...
public:
    virtual void STDMETHODCALLTYPE GetDesc(
            /* [annotation] */
            __out D3D11_UNORDERED_ACCESS_VIEW_DESC
...
public:
    virtual void STDMETHODCALLTYPE GetClassLinkage(
            /* [annotation] */
            __out ID3D11ClassLinkage

    **ppLinkage) = 0;

    virtual void STDMETHODCALLTYPE GetDesc(
            /* [annotation] */
            __out D3D11_CLASS_INSTANCE_DESC
...
public:
    ...
    *pResource,
    ...
    MapFlags,
    /* [annotation] */
    __out D3D11_MAPPED_SUBRESOURCE
    *pMappedResource) = 0;
    ...
    *pDstBuffer,
    ...
    /* [annotation] */
    __in ID3D11UnorderedAccessView
    *pSrcView) = 0;
    ...
    *pNumClassInstances) = 0;
    ...
    virtual void STDMETHODCALLTYPE IAGetPrimitiveTopology(
            /* [annotation] */
            __out D3D11_PRIMITIVE_TOPOLOGY
...
public:
    ...
    *pResource,
    ...
    /* [annotation] */
    __out_opt ID3D11ShaderResourceView
    **ppSRView) = 0;
    ...
    *pResource,
    ...
    /* [annotation] */
    __out_opt ID3D11UnorderedAccessView
    **ppUAView) = 0;
    ...
    *pResource,
    ...
    /* [annotation] */
    __out_opt ID3D11RenderTargetView
    **ppRTView) = 0;
    ...
    *pResource,
    ...
    /* [annotation] */
    __out_opt ID3D11DepthStencilView
    ...
    *pBlendStateDesc,
    ...
    virtual HRESULT STDMETHODCALLTYPE CreateDepthStencilState(
            /* [annotation] */
            __in const D3D11_DEPTH_STENCIL_DESC
    ...
    *pDepthStencilDesc,
    ...
    virtual HRESULT STDMETHODCALLTYPE CreateRasterizerState(
            /* [annotation] */
            __in const D3D11_RASTERIZER_DESC
...
typedef HRESULT (WINAPI *PFN_D3D11_CREATE_DEVICE_AND_SWAP_CHAIN)(__in_opt IDXGIAdapter *,
                                                                 ...
                                                                 UINT FeatureLevels, UINT, __in_opt
                                                                 CONST DXGI_SWAP_CHAIN_DESC *,
                                                                 __out_opt IDXGISwapChain **, __out_opt ID3D11Device **,
                                                                 __out_opt D3D_FEATURE_LEVEL *, __out_opt
                                                                 ID3D11DeviceContext **);
