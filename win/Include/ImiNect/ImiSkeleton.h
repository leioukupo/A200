 ...
 **/
IMINECT_EXP int32_t
imiGetUserColorSegment(const int32_t *userId, const uint8_t length, ImiCoordinateConvertMode type, uint8_t *userDepth,
                       uint8_t *userColor);
 ...
 **/
IMINECT_EXP int32_t
imiGetSkeletonJointOrientation(const ImiSkeletonData *pSkeletonData, ImiSkeletonJointOrientation *pJointOrientation);
