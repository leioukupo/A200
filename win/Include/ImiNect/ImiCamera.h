 ...
 * return 0: success, < 0 : error
 */
IMICAMERA_EXP int32_t
imiCamOpen2(int32_t vid, int32_t pid, int32_t fd, int32_t busnum, int32_t devaddr, const char *usbfs,
            ImiCameraHandle *pCameraDevice);
 ...
 **/
IMICAMERA_EXP int32_t
imiCamGetSupportFrameModes(ImiCameraHandle cameraDevice, const ImiCameraFrameMode **pMode, uint32_t *pNumber);
...
IMICAMERA_EXP int32_t
imiCamSetProperty(ImiCameraHandle cameraDevice, uint32_t propertyId, const void *pData, uint32_t dataSize);

IMICAMERA_EXP int32_t
imiCamGetProperty(ImiCameraHandle cameraDevice, uint32_t propertyId, void *pData, uint32_t *pDataSize);

IMICAMERA_EXP int32_t imiCamSetFramesSync(ImiCameraHandle cameraDevice, bool bSync);

IMICAMERA_EXP int32_t imiCamStartOrStopStream(ImiCameraHandle cameraDevice, bool bStart);

IMICAMERA_EXP int32_t
imiCamSetExposureArea(ImiCameraHandle cameraDevice, uint32_t startX, uint32_t startY, uint32_t areaWidth,
                      uint32_t areaHeight);
