...
typedef void (_stdcall *ImiDeviceUpgradeStepPromptUser)(IMI_UPGRADE_PROMPT promptID, float progress,
                                                        IMI_UPGRADE_ERRCODE errCode, const char *errMsg,
                                                        void *pUserData);
...
IMINECT_EXP int32_t imiDeviceStartUpgradeOffLine(ImiDeviceHandle pDevice, const ImiUpgradeCallbacks *pCallbacks,
                                                 const ImiUpgradeRomPath *pUpgradeRomPath);
