...
public:
    virtual HRESULT STDMETHODCALLTYPE GetDesc(
            /* [annotation][out] */
            __out DXGI_SURFACE_DESC

    *pDesc) = 0;

    virtual HRESULT STDMETHODCALLTYPE Map(
            /* [annotation][out] */
            __out DXGI_MAPPED_RECT
...
public:
    ...
    *pDesc) = 0;
    ...
    virtual HRESULT STDMETHODCALLTYPE GetDisplayModeList(
            ...
            /* [annotation][out] */
                       __out_ecount_part_opt(*pNumModes,
    ...
    *pDevice,
    ...
    virtual HRESULT STDMETHODCALLTYPE GetGammaControlCapabilities(
            /* [annotation][out] */
            __out DXGI_GAMMA_CONTROL_CAPABILITIES

    *pGammaCaps) = 0;

    virtual HRESULT STDMETHODCALLTYPE SetGammaControl(
            /* [annotation][in] */
            __in const DXGI_GAMMA_CONTROL

    *pArray) = 0;

    virtual HRESULT STDMETHODCALLTYPE GetGammaControl(
            /* [annotation][out] */
            __out DXGI_GAMMA_CONTROL
...
public:
    ...
    *pDevice,
    /* [annotation][in] */
    __in DXGI_SWAP_CHAIN_DESC
    *pDesc,
    /* [annotation][out] */
    __out IDXGISwapChain
    **ppSwapChain) = 0;
