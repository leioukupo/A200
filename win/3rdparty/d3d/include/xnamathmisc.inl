...
XMVECTOR T = XMVectorReplicate(t);
return
XMQuaternionSquadV(Q0, Q1, Q2, Q3, T
);
}
...
return
XMVector4NearEqual(NP1, NP2, Epsilon
);
}
...
{
return
XMVector4TransformStream(pOutputStream,
        OutputStride,
        pInputStream,
        InputStride,
        PlaneCount,
...
for (
Line = LineNumber, pLineString = aLineString + XMASSERT_LINE_STRING_SIZE - 2;
Line != 0 && pLineString >=
aLineString;
Line /= 10, pLineString--)
{
...
OutputDebugStringA(pLineString
+ 1);
OutputDebugStringA("\r\n");
#else
