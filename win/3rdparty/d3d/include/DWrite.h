...
interface DWRITE_DECLARE_INTERFACE("cca920e4-52f0-492b-bfa8-29c72ee0a468") IDWriteFontCollectionLoader
    ...
    STDMETHOD(CreateEnumeratorFromKey)(
            ...
            __out IDWriteFontFileEnumerator
...
interface DWRITE_DECLARE_INTERFACE("9c906818-31d7-4fd3-a151-7c5e225db55a") IDWriteTextFormat : public IUnknown {
    ...
    * trimmingOptions,
    ...
    STDMETHOD(GetTrimming)(
            __out DWRITE_TRIMMING

    * trimmingOptions,
    __out IDWriteInlineObject
    ** trimmingSign
    ) PURE;
    ...
    STDMETHOD(GetLineSpacing)(
            __out DWRITE_LINE_SPACING_METHOD
...
interface DECLSPEC_UUID("688e1a58-5094-47c8-adc8-fbcea60ae92b") DECLSPEC_NOVTABLE IDWriteTextAnalysisSource
    ...
    * textLength,
    __out IDWriteNumberSubstitution
    ** numberSubstitution
    ) PURE;
};
...
interface DECLSPEC_UUID("5810cd44-0ca0-4701-b3fa-bec5182ae4f6") DECLSPEC_NOVTABLE IDWriteTextAnalysisSink
    ...
    STDMETHOD(SetScriptAnalysis)(
            UINT32 textPosition,
            UINT32 textLength,
            __in DWRITE_SCRIPT_ANALYSIS const
    ...
    * scriptAnalysis
    ...
    STDMETHOD(SetNumberSubstitution)(
            UINT32 textPosition,
            UINT32 textLength,
            __notnull IDWriteNumberSubstitution
...
interface DWRITE_DECLARE_INTERFACE("b7e6163e-7f46-43b4-84b3-e4e6249c365d") IDWriteTextAnalyzer : public IUnknown {
    ...
    * scriptAnalysis,
    __in_z_opt WCHAR
    const* localeName,
    __maybenull IDWriteNumberSubstitution
    * numberSubstitution,
    ...
    * scriptAnalysis,
    ...
    __out_ecount(glyphCount) DWRITE_GLYPH_OFFSET
    * glyphOffsets
    ) PURE;
...
struct DWRITE_GLYPH_RUN {
    ...
    /// </summary>    
    __field_ecount(glyphCount)
    UINT16 const *glyphIndices;

    /// <summary>
    /// Glyph advance widths.
    /// </summary>
    __field_ecount_opt(glyphCount)
...
interface DWRITE_DECLARE_INTERFACE("8339FDE3-106F-47ab-8373-1C6295EB10B3") IDWriteInlineObject : public IUnknown {
    ...
    * clientDrawingEffect
    ...
    STDMETHOD(GetMetrics)(
            __out DWRITE_INLINE_OBJECT_METRICS
...
interface DWRITE_DECLARE_INTERFACE("ef8a8135-5cc6-45fe-8825-c5a0724eb819") IDWriteTextRenderer
    ...
    * clientDrawingEffect
    ...
    STDMETHOD(DrawStrikethrough)(
            ...
            FLOAT baselineOriginX,
            FLOAT baselineOriginY,
            __in DWRITE_STRIKETHROUGH const
...
interface DWRITE_DECLARE_INTERFACE("1edd9491-9853-4299-898f-6432983b6f3a") IDWriteGdiInterop : public IUnknown {
    ...
    ** fontFace
    ...
    STDMETHOD(CreateBitmapRenderTarget)(
            ...
            UINT32 width,
            UINT32 height,
            __out IDWriteBitmapRenderTarget
...
interface DWRITE_DECLARE_INTERFACE("b859ee5a-d838-4b5b-a2e8-1adc7d93db48") IDWriteFactory : public IUnknown {
    ...
    * fontFamilyName,
    __maybenull IDWriteFontCollection
    * fontCollection,
    DWRITE_FONT_WEIGHT fontWeight,
            DWRITE_FONT_STYLE
    fontStyle,
