...
protected:
    ...
    ////
    HRESULT
    ValidateFormatPair(const WAVEFORMATEX *pSupportedFormat, __inout WAVEFORMATEX *pRequestedFormat, BOOL fOverwrite);
    ...
    //  void
    ////
    void ProcessThru(__in void *pInputBuffer, __inout FLOAT32 *pOutputBuffer, UINT32 FrameCount, WORD InputChannelCount,
...
public:
    ...
    STDMETHOD(IsInputFormatSupported)(const WAVEFORMATEX *pOutputFormat, const WAVEFORMATEX *pRequestedInputFormat,
    ...
    // This default implementation assumes only the format described by the
    // XAPOBASE_DEFAULT_FORMAT values are supported for both input and output.
    STDMETHOD(IsOutputFormatSupported)(const WAVEFORMATEX *pInputFormat, const WAVEFORMATEX *pRequestedOutputFormat,
    ...
    STDMETHOD(LockForProcess)(UINT32 InputLockedParameterCount, __in_ecount_opt(InputLockedParameterCount)
...
public:
    ...
    ////
    CXAPOParametersBase(const XAPO_REGISTRATION_PROPERTIES *pRegistrationProperties, BYTE *pParameterBlocks,
