...
5a508685, a254, 4fba, 9b, 82, 9a, 24, b0, 03, 06, af);
DEFINE_CLSID(XAudio2_Debug, db05ea35,
0329, 4d4b, a5, 3a, 6d, ea, d0, 3d, 38, 52);
DEFINE_IID(IXAudio2,
8bcf1f58, 9fe7, 4583, 8a, c6, e2, ad, c4, 65, c8, bb);
...
DECLARE_INTERFACE_(IXAudio2, IUnknown) {
    ...
    //
    STDMETHOD(GetDeviceCount)(THIS_ __out UINT32
    ...
    * pCount) PURE;
    ...
    //
    STDMETHOD(GetDeviceDetails)(THIS_ UINT32 Index, __out XAUDIO2_DEVICE_DETAILS
    ...
    * pDeviceDetails) PURE;
    ...
    //
    STDMETHOD(RegisterForCallbacks)(__in IXAudio2EngineCallback
    ...
    * pCallback) PURE;
    ...
    //
    STDMETHOD_(void, UnregisterForCallbacks)(__in IXAudio2EngineCallback
    ...
    * pCallback) PURE;
    ...
    STDMETHOD(CreateSourceVoice)(THIS_ __deref_out IXAudio2SourceVoice **ppSourceVoice,
                                 __in const WAVEFORMATEX

    * pSourceFormat,
    UINT32 Flags X2DEFAULT(0),
    float MaxFrequencyRatio X2DEFAULT(XAUDIO2_DEFAULT_FREQ_RATIO),
    __in_opt IXAudio2VoiceCallback
    *
    pCallback X2DEFAULT(NULL),
    __in_opt
    ...
    //
    STDMETHOD_(void, GetPerformanceData)(THIS_ __out XAUDIO2_PERFORMANCE_DATA
...
DECLARE_INTERFACE_(IXAudio2SourceVoice, IXAudio2Voice) {
    ...
    //
    STDMETHOD(SubmitSourceBuffer)(THIS_ __in const XAUDIO2_BUFFER

    * pBuffer, __in_opt const XAUDIO2_BUFFER_WMA *pBufferWMA X2DEFAULT(NULL)
    ) PURE;
    ...
    //
    STDMETHOD_(void, GetState)(THIS_ __out XAUDIO2_VOICE_STATE
...
__inline HRESULT XAudio2Create(__deref_out IXAudio2 * *ppXAudio2, UINT32
Flags X2DEFAULT(0),
        XAUDIO2_PROCESSOR
XAudio2Processor X2DEFAULT(XAUDIO2_DEFAULT_PROCESSOR)
)
{
