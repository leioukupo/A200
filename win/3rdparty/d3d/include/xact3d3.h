...
X3DAudioInitialize(wfxFinalMixFormat
.dwChannelMask, nSpeedOfSound, X3DInstance);
}
}
return
hr;
...
////
EXTERN_C HRESULT
inline XACT3DCalculate (__in
X3DAUDIO_HANDLE X3DInstance, __in
const X3DAUDIO_LISTENER *pListener, __inout
X3DAUDIO_EMITTER *pEmitter, __inout
...
case 2: pEmitter->
pChannelAzimuths = (float *) &aStereoLayout[0];
break;
case 3: pEmitter->
pChannelAzimuths = (float *) &a2Point1Layout[0];
break;
case 4: pEmitter->
pChannelAzimuths = (float *) &aQuadLayout[0];
break;
case 5: pEmitter->
pChannelAzimuths = (float *) &a4Point1Layout[0];
break;
case 6: pEmitter->
pChannelAzimuths = (float *) &a5Point1Layout[0];
break;
case 8: pEmitter->
pChannelAzimuths = (float *) &a7Point1Layout[0];
break;
default:
hr = E_FAIL;
break;
...
pEmitter->
pVolumeCurve = &DefaultCurve;
}
if (pEmitter->pLFECurve == NULL) {
pEmitter->
pLFECurve = &DefaultCurve;
}

X3DAudioCalculate(X3DInstance, pListener, pEmitter, (X3DAUDIO_CALCULATE_MATRIX
| X3DAUDIO_CALCULATE_DOPPLER | X3DAUDIO_CALCULATE_EMITTER_ANGLE), pDSPSettings);
}
...
////
EXTERN_C HRESULT
inline XACT3DApply (__in
const X3DAUDIO_DSP_SETTINGS *pDSPSettings, __in
IXACT3Cue *pCue
)
{
HRESULT hr = S_OK;
...
hr = pCue->SetMatrixCoefficients(pDSPSettings->SrcChannelCount, pDSPSettings->DstChannelCount,
