...
XMINLINE BOOL
XMMatrixDecompose( XMVECTOR
*outScale,
XMVECTOR *outRotQuat, XMVECTOR
*outTrans,
CXMMATRIX M
)
{
...
ppvBasis[a][0] =
XMVector3Normalize(ppvBasis[a][0]);
...
ppvBasis[b][0] =
XMVector3Normalize(ppvBasis[b][0]);

if(pfScales[c] < XM_DECOMP_EPSILON)
{
ppvBasis[c][0] =
XMVector3Cross(ppvBasis[a][0], ppvBasis[b][0]
);
}

ppvBasis[c][0] =
XMVector3Normalize(ppvBasis[c][0]);
...
outRotQuat[0] =
XMQuaternionRotationMatrix(matTemp);
return
TRUE;
}
...
(
        FXMVECTOR
Angles // <Pitch, Yaw, Roll, undefined>
)
{
XMVECTOR Q;
XMMATRIX M;
...
XMFINLINE _XMFLOAT3X3
&

_XMFLOAT3X3::operator=
        (
                CONST _XMFLOAT3X3 &
...
XMFINLINE _XMFLOAT4X3
&

_XMFLOAT4X3::operator=
        (
                CONST _XMFLOAT4X3 &
...
XMFINLINE XMFLOAT4X3A
&

XMFLOAT4X3A::operator=
        (
                CONST XMFLOAT4X3A &
...
XMFINLINE _XMFLOAT4X4
&

_XMFLOAT4X4::operator=
        (
                CONST _XMFLOAT4X4 &
...
XMFINLINE XMFLOAT4X4A
&

XMFLOAT4X4A::operator=
        (
                CONST XMFLOAT4X4A &
