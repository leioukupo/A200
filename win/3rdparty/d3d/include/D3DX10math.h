...
__out_ecount(4) FLOAT *
WINAPI D3DXSHMultiply2(__out_ecount(4)  FLOAT *pOut, __in_ecount(4)  CONST FLOAT *pF, __in_ecount(4)  CONST FLOAT *pG);
__out_ecount(9) FLOAT *
WINAPI D3DXSHMultiply3(__out_ecount(9)  FLOAT *pOut, __in_ecount(9)  CONST FLOAT *pF, __in_ecount(9)  CONST FLOAT *pG);
__out_ecount(16) FLOAT *
WINAPI D3DXSHMultiply4(__out_ecount(16) FLOAT *pOut, __in_ecount(16) CONST FLOAT *pF, __in_ecount(16) CONST FLOAT *pG);
__out_ecount(25) FLOAT *
WINAPI D3DXSHMultiply5(__out_ecount(25) FLOAT *pOut, __in_ecount(25) CONST FLOAT *pF, __in_ecount(25) CONST FLOAT *pG);
__out_ecount(36) FLOAT *
WINAPI D3DXSHMultiply6(__out_ecount(36) FLOAT *pOut, __in_ecount(36) CONST FLOAT *pF, __in_ecount(36) CONST FLOAT *pG);
