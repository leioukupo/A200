...
DirectSoundCreate(__in_opt LPCGUID pcGuidDevice, __deref_out LPDIRECTSOUND *ppDS, __null LPUNKNOWN pUnkOuter ) ;
...
extern HRESULT WINAPI DirectSoundCaptureCreate(__in_opt LPCGUID pcGuidDevice, __deref_out
                                               LPDIRECTSOUNDCAPTURE *ppDSC, __null LPUNKNOWN pUnkOuter ) ;
...
extern HRESULT WINAPI DirectSoundCaptureCreate8(__in_opt LPCGUID pcGuidDevice, __deref_out
                                                LPDIRECTSOUNDCAPTURE8 *ppDSC8, __null LPUNKNOWN pUnkOuter ) ;
...
DECLARE_INTERFACE_(IReferenceClock, IUnknown) {
    // IUnknown methods
    STDMETHOD(QueryInterface)(THIS_ __in REFIID, __deref_out LPVOID
    ...
    *) PURE;
    ...
    STDMETHOD(GetTime)(THIS_ __out REFERENCE_TIME
...
DECLARE_INTERFACE_(IDirectSound, IUnknown) {
    ...
    *) PURE;
    ...
    STDMETHOD(CreateSoundBuffer)(THIS_ __in LPCDSBUFFERDESC pcDSBufferDesc, __deref_out LPDIRECTSOUNDBUFFER *ppDSBuffer,
    ...
    STDMETHOD(DuplicateSoundBuffer)(THIS_ __in LPDIRECTSOUNDBUFFER pDSBufferOriginal, __deref_out
...
DECLARE_INTERFACE_(IDirectSound8, IDirectSound) {
    ...
    *) PURE;
    ...
    // IDirectSound methods
    STDMETHOD(CreateSoundBuffer)(THIS_ __in LPCDSBUFFERDESC pcDSBufferDesc, __out LPDIRECTSOUNDBUFFER
    ...
    *ppDSBuffer, __null
    ...
    STDMETHOD(DuplicateSoundBuffer)(THIS_ __in LPDIRECTSOUNDBUFFER pDSBufferOriginal, __out LPDIRECTSOUNDBUFFER

    *ppDSBufferDuplicate) PURE;
...
DECLARE_INTERFACE_(IDirectSoundBuffer, IUnknown) {
    ...
    *) PURE;
    ...
    STDMETHOD(GetCurrentPosition)(THIS_ __out_opt LPDWORD pdwCurrentPlayCursor, __out_opt
                                  LPDWORD pdwCurrentWriteCursor) PURE;

    STDMETHOD(GetFormat)(THIS_ __out_bcount_opt(dwSizeAllocated) LPWAVEFORMATEX pwfxFormat, DWORD dwSizeAllocated,
                         __out_opt LPDWORD pdwSizeWritten) PURE;
    ...
    STDMETHOD(Lock)(THIS_ DWORD dwOffset, DWORD dwBytes,
                    ...
                    __deref_opt_out_bcount(*pdwAudioBytes2) LPVOID *ppvAudioPtr2, __out_opt LPDWORD pdwAudioBytes2,
                    DWORD dwFlags) PURE;
...
DECLARE_INTERFACE_(IDirectSoundBuffer8, IDirectSoundBuffer) {
    ...
    *) PURE;
    ...
    STDMETHOD(SetFX)(THIS_ DWORD dwEffectsCount, __in_ecount_opt(dwEffectsCount) LPDSEFFECTDESC pDSFXDesc,
                     __out_ecount_opt(dwEffectsCount) LPDWORD pdwResultCodes) PURE;

    STDMETHOD(AcquireResources)(THIS_ DWORD dwFlags, DWORD dwEffectsCount, __out_ecount(dwEffectsCount)
                                LPDWORD pdwResultCodes) PURE;

    STDMETHOD(GetObjectInPath)(THIS_ __in REFGUID

    rguidObject,
    DWORD dwIndex, __in
    REFGUID rguidInterface, __deref_out LPVOID
    *ppObject) PURE;
};
...
DECLARE_INTERFACE_(IDirectSound3DListener, IUnknown) {
    ...
    *) PURE;
    ...
    STDMETHOD(GetDistanceFactor)(THIS_ __out D3DVALUE

    * pflDistanceFactor) PURE;

    STDMETHOD(GetDopplerFactor)(THIS_ __out D3DVALUE

    * pflDopplerFactor) PURE;

    STDMETHOD(GetOrientation)(THIS_ __out D3DVECTOR

    * pvOrientFront,
    __out D3DVECTOR
    * pvOrientTop) PURE;

    STDMETHOD(GetPosition)(THIS_ __out D3DVECTOR

    * pvPosition) PURE;

    STDMETHOD(GetRolloffFactor)(THIS_ __out D3DVALUE

    * pflRolloffFactor) PURE;

    STDMETHOD(GetVelocity)(THIS_ __out D3DVECTOR
...
DECLARE_INTERFACE_(IDirectSound3DBuffer, IUnknown) {
    ...
    *) PURE;
    ...
    STDMETHOD(GetConeOrientation)(THIS_ __out D3DVECTOR

    * pvOrientation) PURE;

    STDMETHOD(GetConeOutsideVolume)(THIS_ __out LPLONG plConeOutsideVolume) PURE;

    STDMETHOD(GetMaxDistance)(THIS_ __out D3DVALUE

    * pflMaxDistance) PURE;

    STDMETHOD(GetMinDistance)(THIS_ __out D3DVALUE
...
DECLARE_INTERFACE_(IDirectSoundCapture, IUnknown) {
    ...
    *) PURE;
    ...
    STDMETHOD(CreateCaptureBuffer)(THIS_ __in LPCDSCBUFFERDESC pcDSCBufferDesc, __deref_out
...
DECLARE_INTERFACE_(IDirectSoundCaptureBuffer, IUnknown) {
    ...
    *) PURE;
    ...
    STDMETHOD(Initialize)(THIS_ __in LPDIRECTSOUNDCAPTURE pDirectSoundCapture, __in LPCDSCBUFFERDESC
...
DECLARE_INTERFACE_(IDirectSoundNotify, IUnknown) {
    ...
    *) PURE;
    ...
    STDMETHOD(SetNotificationPositions)(THIS_ DWORD dwPositionNotifies, __in_ecount(dwPositionNotifies)
...
DECLARE_INTERFACE_(IKsPropertySet, IUnknown) {
    ...
    *) PURE;
    ...
    STDMETHOD(Get)(THIS_ __in REFGUID

    rguidPropSet,
    ULONG ulId, __in_bcount(ulInstanceLength) LPVOID
    pInstanceData,
    ULONG ulInstanceLength,
    __out_bcount(ulDataLength) LPVOID
    pPropertyData,
    ULONG ulDataLength, __out
    PULONG pulBytesReturned
    ) PURE;

    STDMETHOD(Set)(THIS_ __in REFGUID

    rguidPropSet,
    ULONG ulId, __in_bcount(ulInstanceLength) LPVOID
    pInstanceData,
    ULONG ulInstanceLength,
    __in_bcount(ulDataLength) LPVOID
    pPropertyData,
    ULONG ulDataLength
    ) PURE;

    STDMETHOD(QuerySupport)(THIS_ __in REFGUID
...
DECLARE_INTERFACE_(IDirectSoundFXI3DL2Reverb, IUnknown) {
    ...
    *) PURE;
    ...
    STDMETHOD(GetQuality)(THIS_ __out LONG
...
DECLARE_INTERFACE_(IDirectSoundFullDuplex, IUnknown) {
    ...
    *) PURE;
    ...
    STDMETHOD(Initialize)(THIS_ __in LPCGUID pCaptureGuid, __in LPCGUID pRenderGuid, __in LPCDSCBUFFERDESC
                          lpDscBufferDesc, __in LPCDSBUFFERDESC lpDsBufferDesc, HWND hWnd, DWORD dwLevel,
                          __deref_out LPLPDIRECTSOUNDCAPTUREBUFFER8 lplpDirectSoundCaptureBuffer8, __deref_out
