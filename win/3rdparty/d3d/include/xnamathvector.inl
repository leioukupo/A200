...
// function to use due to performance loss.
XMFINLINE UINT
XMVectorGetIntByIndex(FXMVECTOR
V,
UINT i
)
{
...
// This causes Load/Hit/Store on VMX targets
XMFINLINE XMVECTOR
XMVectorSetByIndexPtr(FXMVECTOR
V,
CONST FLOAT
*f,
UINT i
...
// This causes Load/Hit/Store on VMX targets
XMFINLINE XMVECTOR
XMVectorSetIntByIndex(FXMVECTOR
V,
UINT x, UINT
i)
{
...
// This causes Load/Hit/Store on VMX targets
XMFINLINE XMVECTOR
XMVectorSetIntByIndexPtr(FXMVECTOR
V,
CONST UINT
*x,
UINT i
...
XMASSERT(VectorIndex0<
2);
XMASSERT(VectorIndex1<
2);
XMASSERT(VectorIndex2<
2);
XMASSERT(VectorIndex3<
2);
...
#else // _XM_VMX128_INTRINSICS_
return
XMComparisonAllTrue(XMVector2EqualR(V1, V2)
);
#endif
}
...
#else // _XM_VMX128_INTRINSICS_
return
XMComparisonAllTrue(XMVector2EqualIntR(V1, V2)
);
#endif
}
...
#else // _XM_VMX128_INTRINSICS_
return
XMComparisonAnyFalse(XMVector2EqualR(V1, V2)
);
#endif
}
...
#else // _XM_VMX128_INTRINSICS_
return
XMComparisonAnyFalse(XMVector2EqualIntR(V1, V2)
);
#endif
}
...
#else // _XM_VMX128_INTRINSICS_
return
XMComparisonAllTrue(XMVector2GreaterR(V1, V2)
);
#endif
}
...
#else // _XM_VMX128_INTRINSICS_
return
XMComparisonAllTrue(XMVector2GreaterOrEqualR(V1, V2)
);
#endif
}
...
#else // _XM_VMX128_INTRINSICS_
return
XMComparisonAllTrue(XMVector2GreaterR(V2, V1)
);
#endif
}
...
#else // _XM_VMX128_INTRINSICS_
return
XMComparisonAllTrue(XMVector2GreaterOrEqualR(V2, V1)
);
#endif
}
...
#else // _XM_VMX128_INTRINSICS_
return
XMComparisonAllInBounds(XMVector2InBoundsR(V, Bounds)
);
#endif
}
...
#else // _XM_VMX128_INTRINSICS_
return
XMComparisonAllTrue(XMVector3EqualR(V1, V2)
);
#endif
}
...
#else // _XM_VMX128_INTRINSICS_
return
XMComparisonAllTrue(XMVector3EqualIntR(V1, V2)
);
#endif
}
...
#else // _XM_VMX128_INTRINSICS_
return
XMComparisonAnyFalse(XMVector3EqualR(V1, V2)
);
#endif
}
...
#else // _XM_VMX128_INTRINSICS_
return
XMComparisonAnyFalse(XMVector3EqualIntR(V1, V2)
);
#endif
}
...
#else // _XM_VMX128_INTRINSICS_
return
XMComparisonAllTrue(XMVector3GreaterR(V1, V2)
);
#endif
}
...
#else // _XM_VMX128_INTRINSICS_
return
XMComparisonAllTrue(XMVector3GreaterOrEqualR(V1, V2)
);
#endif
}
...
#else // _XM_VMX128_INTRINSICS_
return
XMComparisonAllTrue(XMVector3GreaterR(V2, V1)
);
#endif
}
...
#else // _XM_VMX128_INTRINSICS_
return
XMComparisonAllTrue(XMVector3GreaterOrEqualR(V2, V1)
);
#endif
}
...
#else
return
XMComparisonAllInBounds(XMVector3InBoundsR(V, Bounds)
);
#endif
}
...
#else
return
XMComparisonAllTrue(XMVector4EqualR(V1, V2)
);
#endif
}
...
#else
return
XMComparisonAllTrue(XMVector4EqualIntR(V1, V2)
);
#endif
}
...
#else
return
XMComparisonAnyFalse(XMVector4EqualR(V1, V2)
);
#endif
}
...
#else
return
XMComparisonAnyFalse(XMVector4EqualIntR(V1, V2)
);
#endif
}
...
#else
return
XMComparisonAllTrue(XMVector4GreaterR(V1, V2)
);
#endif
}
...
#else
return
XMComparisonAllTrue(XMVector4GreaterOrEqualR(V1, V2)
);
#endif
}
...
#else
return
XMComparisonAllTrue(XMVector4GreaterR(V2, V1)
);
#endif
}
...
#else
return
XMComparisonAllTrue(XMVector4GreaterOrEqualR(V2, V1)
);
#endif
}
...
#else
return
XMComparisonAllInBounds(XMVector4InBoundsR(V, Bounds)
);
#endif
}
...
XMFINLINE _XMUSHORTN2
&
_XMUSHORTN2::operator=
        (
                CONST
_XMUSHORTN2 &UShortN2
)
{
x = UShortN2.x;
y = UShortN2.y;
...
XMFINLINE _XMFLOAT3PK
&
_XMFLOAT3PK::operator=
        (
                CONST
_XMFLOAT3PK &float3pk
)
{
v = float3pk.v;
return *this;
...
XMFINLINE _XMFLOAT3SE
&
_XMFLOAT3SE::operator=
        (
                CONST
_XMFLOAT3SE &float3se
)
{
v = float3se.v;
return *this;
...
{
XMConvertFloatToHalfStream(&x,
sizeof(HALF), pArray, sizeof(FLOAT), 4);
}
...
XMFINLINE _XMUSHORTN4
&
_XMUSHORTN4::operator=
        (
                CONST
_XMUSHORTN4 &UShortN4
)
{
x = UShortN4.x;
y = UShortN4.y;
...
XMFINLINE _XMUNIBBLE4
&
_XMUNIBBLE4::operator=
        (
                CONST
_XMUNIBBLE4 &UNibble4
)
{
v = UNibble4.v;
return *this;
...
{
XMVECTOR V = XMLoadFloat3((XMFLOAT3 * )
pArray);
XMStoreU555(this,
XMVectorSetW(V, ((_w)
? 1.0f : 0.0f)));
