...
DECLARE_INTERFACE_(IXAPO, IUnknown) {
    ...
    //  COM error code
    ////
    STDMETHOD(GetRegistrationProperties)(THIS_ __deref_out
                                         XAPO_REGISTRATION_PROPERTIES **ppRegistrationProperties) PURE;
    ...
    ////
    STDMETHOD(IsInputFormatSupported)(THIS_ const WAVEFORMATEX *pOutputFormat,
    ...
    ////
    STDMETHOD(IsOutputFormatSupported)(THIS_ const WAVEFORMATEX *pInputFormat,
    ...
    //  COM error code
    ////
    STDMETHOD(LockForProcess)(THIS_ UINT32 InputLockedParameterCount, __in_ecount_opt(InputLockedParameterCount)
                              const XAPO_LOCKFORPROCESS_BUFFER_PARAMETERS *pInputLockedParameters,
                              UINT32 OutputLockedParameterCount, __in_ecount_opt(OutputLockedParameterCount)
    ...
    //  void
    ////
    STDMETHOD_(void, Process)(THIS_ UINT32 InputProcessParameterCount, __in_ecount_opt(InputProcessParameterCount)
                              const XAPO_PROCESS_BUFFER_PARAMETERS *pInputProcessParameters,
                              UINT32 OutputProcessParameterCount, __inout_ecount_opt(OutputProcessParameterCount)
...
DECLARE_INTERFACE_(IXAPOParameters, IUnknown) {
    ...
    //  void
    ////
    STDMETHOD_(void, SetParameters)(THIS_ __in_bcount(ParameterByteSize) const void *pParameters,
    ...
    //  void
    ////
    STDMETHOD_(void, GetParameters)(THIS_ __out_bcount(ParameterByteSize) void *pParameters,
                                    UINT32 ParameterByteSize) PURE;
};
