...
V.vector4_f32[0] = (FLOAT)
Element;
Element = (pSource->v >> 5) & 0x3F;
V.vector4_f32[1] = (FLOAT)
Element;
Element = (pSource->v >> 11) & 0x1F;
V.vector4_f32[2] = (FLOAT)
Element;
...
pDestination->
v = (((USHORT) N.vector4_f32[2] & 0x1F) << 11) |
...
pDestination->
v = (((USHORT) N.vector4_f32[3] & 0xF) << 12) |
...
pDestination->
v = ((N.vector4_f32[3] > 0.f) ? 0x8000 : 0) |
